...
IN = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v9_rows351_450.csv"
OUT = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v10_rows351_450.csv"

REPAIR_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows351_450"
LOG_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows351_450_logs"
...
print("BookStore V10 rows 351-450 repair started")
print("Rows:", len(df))
print()
