...
IN = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v9_rows151_250.csv"
OUT = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v10_rows151_250.csv"

REPAIR_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows151_250"
LOG_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows151_250_logs"
...
print("BookStore V10 rows 151-250 repair started")
print("Rows:", len(df))
print()
