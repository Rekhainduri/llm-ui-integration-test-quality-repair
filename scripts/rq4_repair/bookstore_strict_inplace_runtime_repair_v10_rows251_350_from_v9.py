...
IN = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v9_rows251_350.csv"
OUT = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v10_rows251_350.csv"

REPAIR_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows251_350"
LOG_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows251_350_logs"
...
print("BookStore V10 rows 251-350 repair started")
print("Rows:", len(df))
print()
