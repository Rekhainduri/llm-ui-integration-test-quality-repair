...
INPUT_FILE = ROOT / "csv_dataset" / "objective1_spring_unknown_compile_passed_runtime_results.csv"
OUTPUT_FILE = ROOT / "csv_dataset" / "objective1_spring_frozen_runtime_repair_unknown_7_results.csv"

PROJECT_ROOT = ROOT / "projects" / "spring-petclinic"
TEST_DIR = PROJECT_ROOT / "src" / "test" / "java" / "org" / "springframework" / "samples" / "petclinic"

REPAIR_DIR = ROOT / "repair_workspace" / "spring_frozen_runtime_repair_unknown_7"
LOG_DIR = ROOT / "repair_workspace" / "spring_frozen_runtime_repair_unknown_7_logs"
...
def main():
    print("Spring Frozen Runtime Repair for Unknown Compile-Passed Tests")
    print("=" * 90)
