...
IN = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v9_rows101_150.csv"
OUT = ROOT / "csv_dataset" / "objective1_bookstore_strict_inplace_runtime_repair_v10_rows101_150.csv"

REPAIR_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows101_150"
LOG_DIR = ROOT / "repair_workspace" / "bookstore_strict_inplace_runtime_repair_v10_rows101_150_logs"
...
print("BookStore V10 rows 101-150 repair started")
print("Rows:", len(df))
print()
